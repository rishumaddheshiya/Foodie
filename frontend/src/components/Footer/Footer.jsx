  ...
  return (
    <div className="footer-section" id="contact-us">
      <div className="footer-container">
        ...
        <div className="ft-list" id="contact">
          ...
          <li>
            ...
            <li>
              <a href="mailto:rishumaddheshiya999@gmail.com">rishumaddheshiya999@gmail.com</a>
            </li>
            <li>
              <a href="tel:+91 8318058248">+91 8318058248</a>
            </li>
            <li>
              <a href="tel:+91 9580892273">+91 9580892273</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="ft-copyright">
        <p>Copyright©  Rishu Maddheshiya. All rights reserved.</p>
